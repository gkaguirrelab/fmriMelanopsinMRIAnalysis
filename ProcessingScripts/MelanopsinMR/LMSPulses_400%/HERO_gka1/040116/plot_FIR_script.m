...
subject_name =  'HERO_gka1_3T'; %freesurfer subject
subj_name = 'HERO_gka1'; %subject name for figure
dropbox_dir = '/Users/giulia/Dropbox (Aguirre-Brainard Lab)/MELA_analysis/MelanopsinMRMaxMel/HERO_gka1/033116';
...
for jj = 1:length(ROIs)
    ...
    for ff = 1:length(funcs)
        ...
        for i = 1:length(Conditions)
            ...
            plot_FIR(means{i},sems{i},ROI,condName,hemi,funcName,subj_name);
